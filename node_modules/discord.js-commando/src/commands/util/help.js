		...
		if(args.command && !showAll) {
			...
			try {
				messages.push(await msg.direct(stripIndents`
					...
					**play:** Play music from url or search term.
					**skip [num]:** Skip a number of songs. Defaults to 1 skipped song.
					...
					**clearqueue:** Clears the song queue. Only queue creator can clear.
